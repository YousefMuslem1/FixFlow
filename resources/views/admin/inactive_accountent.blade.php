...
@section('title')
<title>InActive Accountant</title>
@endsection
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Display an InActive Accountent</h3>
                    </div>
                    ...
                    <table id="dataTableI" width="100%" class="table table-bordered table-striped dataTable display" >
                       <thead>
				        <tr >
				            <th >ID</th>
					        <th>Name</th>
...
<script>
    ...
    var table = $('#datatableI').DataTable();
          ...
          $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: 'Delete Accountant Has Been Successfully!',
