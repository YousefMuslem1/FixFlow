                    ...
                    <table id="dataTableCompany" width="100%" class="table table-bordered table-striped dataTable display" >
                       <thead>
                        ...
                        font-size: 30px;padding: 0 26px;"></i>
                            ...
                            <td>
                            <a  class="btn btn-sm btn-primary fa fa-eye " href="{{route('accountent.view-public-company-profile',Crypt::encrypt($com->id))}}" > View </a>
                             |
                             @if($com->state == 1)
